...
export const subjects: Subject[] = [
  {
    ...
    blurbAr: 'تعلّم قراءة كتاب الله بنطقٍ صحيح وخشوع.',
    icon: 'book-open',
  ...
  },
  {
    ...
    blurbAr: 'أتقِن علم التلاوة — من المخارج إلى الأحكام المتقدّمة.',
    icon: 'music-2',
  ...
  },
  {
    ...
    blurbAr: 'اقرأ واكتب وتحدّث العربية الفصحى — لغة الوحي.',
    icon: 'languages',
  ...
  },
  {
    ...
    blurbAr: 'افهم الأحكام التي تنظّم صلاتك وصيامك وعباداتك اليوميّة.',
    icon: 'scale',
  ...
  },
  {
    ...
    blurbAr: 'ابنِ فهمًا واضحًا وراسخًا للعقيدة الإسلامية.',
    icon: 'shield-check',
  ...
  },
  {
    ...
    blurbAr: 'تدبّر معاني القرآن آيةً آية.',
    icon: 'sparkles',
  ...
  },
  {
    ...
    blurbAr: 'سِر مع النبيّ ﷺ — من مكة إلى المدينة.',
    icon: 'compass',
  ...
  },
  {
    ...
    blurbAr: 'ادرس الأحاديث الصحيحة ومنهج العلماء.',
    icon: 'feather',
